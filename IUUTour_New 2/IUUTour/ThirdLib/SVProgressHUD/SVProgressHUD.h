...
//  Added by Vincent on Sep 19 2015
//  HUD owership can be transferred to others.
//  For example, switching from one page to another, and both pages show long HUD)
//  I don't like the previous page to dismiss the HUD while the current page is using it.
//  These functions also support dismissing after 0.5f delay (that is, the HUD won't flicker)
